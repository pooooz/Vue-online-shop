  ...
  <header class="header">
    <div class="container">
      <div class="header__wrap">
        <div>
          <a class="header__logo" :href="routes.index">
            ...
            <a :href="routes.product" class="header__search">
        ...
        <div class="header__nav-group">
          <a :href="routes.catalog">
            ...
            <a class="header__link" :href="routes.registration">
            ...
            <a class="header__link" :href="routes.cart">
